            ...
            else
            {
                ...
                switch (this.DataType)
                {
                    case EDataType.varReference:
                        attribute.Value = String.Format("{0}:{1:X8} {2}", this.DataType, this._br.ReadUInt32(), this.ReadGuid(false));
                        break;
                    ...
                    case EDataType.varWeakPointer:
                        attribute.Value = String.Format("{0}:{1:X8} {1:X8}", this.DataType, this._br.ReadUInt32(), this._br.ReadUInt32());
                        break;
