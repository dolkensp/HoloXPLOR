...
{
    [XmlRoot(ElementName = "BTGetUseChannelPlacement")]
    public partial class BTGetUseChannelPlacement : BTNode
    {
        ...
        [XmlArray(ElementName = "Selection")]
        [XmlArrayItem(Type = typeof(BTInputString))]
        [XmlArrayItem(Type = typeof(BTInputStringValue))]
        [XmlArrayItem(Type = typeof(BTInputStringVar))]
        [XmlArrayItem(Type = typeof(BTInputStringBB))]
        public BTInputString[] Selection { get; set; }
